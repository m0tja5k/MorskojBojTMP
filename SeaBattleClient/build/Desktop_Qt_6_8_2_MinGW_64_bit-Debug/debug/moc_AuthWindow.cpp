...
void AuthWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AuthWindow::*)(const QString & , const QString & );
            if (_q_method_type _q_method = &AuthWindow::loginRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (AuthWindow::*)();
            if (_q_method_type _q_method = &AuthWindow::registerRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AuthWindow::loginRequested(const QString & _t1, const QString & _t2)
{
...
// SIGNAL 1
void AuthWindow::registerRequested()
{
