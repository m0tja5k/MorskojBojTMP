...
public:
    ...
    int getGameId() const { return currentGameId; } // Метод для получения game_id
...
signals:
    ...
    // Сигналы для обработки ответов сервера
...
private:
    ...
    int currentGameId = -1; // Добавляем поле для хранения game_id
};
